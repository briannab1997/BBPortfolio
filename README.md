...
Built with **vanilla HTML, CSS, and JavaScript** — no frameworks, no dependencies. Features include:

- 🎨 Dark / Light mode with `localStorage` persistence
- ✨ Animated particle background (Canvas API)
- 📊 Scroll-triggered stat counters (IntersectionObserver)
...
🌐 **Portfolio:** [briannab1997.github.io/BBPortfolio](https://briannab1997.github.io/BBPortfolio/)
💼 **LinkedIn:** [linkedin.com/in/brianna-brockington](https://www.linkedin.com/in/brianna-brockington)
